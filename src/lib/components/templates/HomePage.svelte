...
>
  <!-- Hero Section -->
  <section class="home-page__hero" aria-label="Seção principal">
    <slot name="hero" {dispatch} />
  </section>

  <!-- Stats Section -->
  <section class="home-page__stats" aria-label="Estatísticas">
    <slot name="stats" {dispatch} />
  </section>

  <!-- About Section -->
  <section class="home-page__about" aria-label="Sobre nós">
    <slot name="about" {dispatch} />
  </section>

  <!-- Initiatives Section -->
  <section class="home-page__initiatives" aria-label="Nossas iniciativas">
    <slot name="initiatives" {dispatch} />
  </section>

  <!-- Testimonials Section -->
  <section class="home-page__testimonials" aria-label="Depoimentos">
