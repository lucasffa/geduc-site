...
<script lang="ts">
  ...
  const footerData = {
    ...
    description: 'GEDUC é a maior ONG educacional do Brasil, dedicada a democratizar o acesso ao ensino superior de qualidade.',
    contact: {
...
>
  ...
  <svelte:fragment slot="head">
    ...
    <meta name="keywords" content={'keywords' in data.pageData.meta && data.pageData.meta.keywords ? data.pageData.meta.keywords.join(', ') : ''} />
    ...
    <meta property="og:image" content={'image' in data.pageData.meta ? data.pageData.meta.image || '' : ''} />
  ...
  <svelte:fragment slot="stats" let:dispatch>
    <StatsSection
      title={'title' in data.pageData.stats ? data.pageData.stats.title : undefined}
      description={'description' in data.pageData.stats ? data.pageData.stats.description : undefined}
      stats={data.pageData.stats.stats}
      layout={data.pageData.stats.layout}
      columns={data.pageData.stats.columns}
      background={'background' in data.pageData.stats ? data.pageData.stats.background : undefined}
  ...
  <svelte:fragment slot="initiatives" let:dispatch>
    <InitiativesSection
      ...
      description={'description' in data.pageData.initiatives ? data.pageData.initiatives.description : undefined}
      ...
      filterable={'filterable' in data.pageData.initiatives ? data.pageData.initiatives.filterable : undefined}
  ...
  <svelte:fragment slot="testimonials" let:dispatch>
    <TestimonialsSection
      ...
      description={'description' in data.pageData.testimonials ? data.pageData.testimonials.description : undefined}
      ...
      autoplay={'autoplay' in data.pageData.testimonials ? data.pageData.testimonials.autoplay : false}
      autoplayInterval={'autoplayInterval' in data.pageData.testimonials ? data.pageData.testimonials.autoplayInterval : 5000}
      navigation={'navigation' in data.pageData.testimonials ? data.pageData.testimonials.navigation : false}
      indicators={'indicators' in data.pageData.testimonials ? data.pageData.testimonials.indicators : false}
