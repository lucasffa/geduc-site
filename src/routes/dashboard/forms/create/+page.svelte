		...
		<aside class="settings-panel">
			...
			<div class="settings-section">
				<div class="settings-field">
					<label class="settings-label" for="setting-public">
						Formulário público
						<span class="settings-hint">Qualquer pessoa com o link pode responder</span>
					</label>
					<label class="toggle">
						<input id="setting-public" type="checkbox" bind:checked={isPublic} />
						<span class="toggle-track"></span>
					</label>
				</div>

				<div class="settings-field">
					<label class="settings-label" for="setting-auth">
						Requer autenticação
						<span class="settings-hint">Somente usuários logados podem responder</span>
					</label>
					<label class="toggle">
						<input id="setting-auth" type="checkbox" bind:checked={requiresAuth} />
						<span class="toggle-track"></span>
					</label>
				</div>
			</div>
