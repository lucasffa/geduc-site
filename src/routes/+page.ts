...
export const load: PageLoad = async ({ fetch, params }) => {
  try {
    ...
    const pageData: HomePageProps = {
      ...
      about: {
        title: 'Sobre Nós',
        description: 'Construindo pontes entre sonhos e realizações através da educação de qualidade e oportunidades transformadoras.',
        media: {
      ...
      initiatives: {
        ...
        description: 'Programas inovadores e abrangentes que conectam jovens talentos brasileiros às melhores oportunidades educacionais do país.',
        initiatives: [
          {
            id: 'mentoria-oportunidades',
            title: 'Mentoria de Oportunidades',
            description: 'Preparação especializada para vestibulares e processos seletivos das melhores universidades brasileiras.',
          ...
          },
          {
            ...
            description: 'Discussões literárias e filosóficas profundas para ampliar horizontes culturais e desenvolvimento crítico.',
          ...
          },
          {
            ...
            description: 'Desenvolvimento de habilidades interpessoais e competências profissionais essenciais para o século XXI.',
          ...
          },
          {
            ...
            description: 'Oportunidades internacionais exclusivas para ampliar perspectivas globais e vivências multiculturais.',
      ...
      testimonials: {
        title: 'Depoimentos',
        description: 'Histórias reais de transformação e sucesso de estudantes que tiveram suas vidas mudadas através dos nossos programas.',
        testimonials: [
          {
            id: 'testimonial-gabriela',
            quote: 'O programa mudou completamente minha perspectiva sobre educação e possibilidades. Através das mentorias especializadas, consegui ingressar na universidade dos meus sonhos e desenvolver habilidades que nunca imaginei possuir. A rede de apoio é incomparável.',
            author: {
          ...
          },
          {
            ...
            quote: 'A experiência foi transformadora. Os voluntários realmente se importam com nosso crescimento pessoal e profissional. Além do suporte acadêmico, encontrei uma comunidade que me inspirou a sonhar mais alto.',
            author: {
          ...
          {
            id: 'testimonial-ana',
            quote: 'Graças ao GEDUC, consegui não apenas uma vaga na universidade, mas também uma bolsa de estudos integral. O programa me deu ferramentas para vida toda.',
            author: {
